...
@Component({
  selector: 'app-jqx-tree-map',
  templateUrl: './jqx-tree-map.component.html',
  styleUrls: ['./jqx-tree-map.component.css']
})
export class JqxTreeMapComponent implements OnInit {
  ...
  ngOnInit() {
    this.widthBorder= this.jqxTreeMapObjectChild.width - 30;
    this.leftLabel=this.jqxTreeMapObjectChild.width/2;
  }
